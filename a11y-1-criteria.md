...
| **1.4.10** | Reflow | AA | Yes | ✅ Pass | At 320×256 @ dsf 4: `scrollWidth 320 == clientWidth 320`, **zero elements overflow the right edge**, both states; vertical scroll only. `width: 91.66vw` / `max-height: calc(100% - 24px)` / `overflow-y: auto` keeps long modal copy scrolling inside. |
